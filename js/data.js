...
const NATIONAL_EMERGENCY = [
  ...
  { label:'National Hotline', number:'16969',        icon:'\u260E',       color:'#8B5CF6' },
  { label:'Poison Control',   number:'01779-085965', icon:'\u2695',       color:'#059669' },
...
const SAMPLE_SETTINGS = {
  password:    'BADAS@2024',
  hint:        'Contact the BADAS IT department for access.',
  app_version: '2.0.0',
};
